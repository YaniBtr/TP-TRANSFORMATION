 ...
 * @generated
 */
public class ComposantFactoryImpl extends EFactoryImpl implements ComposantFactory {
	/**
	...
	public static ComposantFactory init() {
		try {
			ComposantFactory theComposantFactory = (ComposantFactory) EPackage.Registry.INSTANCE
					.getEFactory(ComposantPackage.eNS_URI);
		...
		return new ComposantFactoryImpl();
	}
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case ComposantPackage.DIRECTION:
